        ...
        @foreach ($banner_tops as $banner_top)
            <div class="container fill_height">
                <div class="row fill_height">
                    <div class="banner_product_image"><img src="{{ asset('img/banner_img/' . $banner_top['image']) }}"
                            alt="{{ $banner_top['alt'] }}"></div>
                    <div class="col-lg-5 offset-lg-4 fill_height">
                        <div class="banner_content">
                            <h1 class="banner_text">{{ $banner_top['title'] }}</h1>
                            <div class="banner_price">৳ {{ $banner_top['new_price'] }} <span>৳
                                    {{ $banner_top['old_price'] }}</span></div>
                                        ...
                                        <div class="featured_slider_item">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset('img/product_img/small/' . $featured_item['main_image']) }}"
                                                        width="115px" height="115px" alt=""></div>
                                                <div class="product_content">

                                                    <div class="product_price discount">
                                                        {{-- <li
                                                            class="product_mark product_new">new</li>
                                                        --}}
                                                    </ul>
                                                @else
                                                    <?php $mark = 'product_discount'; ?>
                                                    <ul class="product_marks">
                                                        <li class="product_mark {{ $mark }}">
                                                            -{{ $featured_item['product_discount'] }}</li>
                                                    </ul>
                                                @endif
                                        ...
                                        @foreach ($latest_products as $latest_product)
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('img/product_img/small/' . $latest_product['main_image']) }}"
                                                            width="115px" height="115px" alt=""></div>
                                                    <div class="product_content">
                                                        ...
                                                        <div class="product_name">
                                                            <div><a title="{{ $featured_item['product_name'] }}"
                                                                    href="product.html">{{ \Illuminate\Support\Str::limit($latest_product['product_name'], 20) }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                        ...
                                        @foreach ($latest_desktop_pc_products as $latest_desktop_pc_product)
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('img/product_img/small/' . $latest_desktop_pc_product['main_image']) }}"
                                                            width="115px" height="115px" alt=""></div>
                                                    <div class="product_content">
                                                        ...
                                                        <div class="product_name">
                                                            <div><a title="{{ $featured_item['product_name'] }}"
                                                                    href="product.html">{{ \Illuminate\Support\Str::limit($latest_desktop_pc_product['product_name'], 20) }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                        ...
                                        @foreach ($latest_laptop_netbook_products as $latest_laptop_netbook_products)
                                            <div class="arrivals_slider_item">
                                                ...
                                                <div
                                                    ...
                                                    <div
                                                        class="product_image d-flex flex-column align-items-center justify-content-center">
                                                        <img src="{{ asset('img/product_img/small/' . $latest_laptop_netbook_products['main_image']) }}"
                                                            width="115px" height="115px" alt=""></div>
                                                    <div class="product_content">
                                                        ...
                                                        <div class="product_name">
                                                            <div><a title="{{ $featured_item['product_name'] }}"
                                                                    href="product.html">{{ \Illuminate\Support\Str::limit($latest_laptop_netbook_products['product_name'], 20) }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="product_extras">
                                                            <div class="product_color">
                                ...
                                <div class="row fill_height">
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            ...
                                            <div class="button banner_2_button"><a href="{{ $bms_1['link'] }}">Explore</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img
                                                    src="{{ asset('img/banner_img/' . $bms_1['image']) }}"
                                                    alt="{{ $bms_1['alt'] }}"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row fill_height">
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            ...
                                            <div class="button banner_2_button"><a href="{{ $bms_2['link'] }}">Explore</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img
                                                    src="{{ asset('img/banner_img/' . $bms_2['image']) }}"
                                                    alt="{{ $bms_2['alt'] }}"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row fill_height">
                                    <div class="col-lg-4 col-md-6 fill_height">
                                        <div class="banner_2_content">
                                            ...
                                            <div class="button banner_2_button"><a href="{{ $bms_3['link'] }}">Explore</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-8 col-md-6 fill_height">
                                        <div class="banner_2_image_container">
                                            <div class="banner_2_image"><img
                                                    src="{{ asset('img/banner_img/' . $bms_3['image']) }}"
                                                    alt="{{ $bms_3['alt'] }}"></div>
                                        </div>
                                    </div>
                                </div>
